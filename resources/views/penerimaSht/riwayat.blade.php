    ...
    @section('content')
        ...
        <div class="card-body shadow mt-3 mb-4">
            ...
            <form action="{{ url('riwayatSht') }}" method="GET" id="filterForm">
            ...
            <table class="table table-bordered table-responsive h-4" id="myTable">
                ...
                <tbody>
                    @if ($riwayat_penerima->count() > 0)
                        @foreach ($riwayat_penerima as $item)
                            <tr>
                                <td class="center">{{ $item->no_riwayat_penerima }}</td>
                                <td class="center">{{ $item->nama }}</td>
                                <td class="center">{{ $item->no_peserta }}</td>
                                <td class="center">{{ $item->jenis_kelamin }}</td>
                                <td class="center">{{ $item->no_peserta_lama }}</td>
                                <td class="center">{{ $item->kd_jenis_pensiun }}</td>
                                <td class="center">{{ $item->nama_jenis_pensiun }}</td>
                                <td class="center">{{ $item->nilai_manfaat_pensiun }}</td>
                                <td class="center">{{ $item->nama_bank }}</td>
                                <td class="center">{{ $item->no_rekening }}</td>
                                <td class="center">{{ $item->atas_nama }}</td>
